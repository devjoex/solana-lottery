...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "Yes, this lottery is now configured for Solana mainnet. All transactions use real SOL. Make sure you have sufficient SOL in your Phantom wallet for ticket purchases and transaction fees."
  }
];
